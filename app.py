...
/* ================================ */
/* ✨ GINI Guardian 타이틀 가독성 향상 */
/* ================================ */

.header-animated,
h1, h2 {
    color: #BFD9FF !important; /* 밝은 하늘빛 파랑 */
    text-shadow:
        0 0 4px rgba(191,217,255,0.9),
        0 0 10px rgba(109,148,255,0.7),
        0 0 18px rgba(80,120,255,0.4) !important;
}

/* 아이콘(방패)도 밝게 */
h1 svg, h2 svg {
    filter: drop-shadow(0 0 6px rgba(150,180,255,0.9));
}
